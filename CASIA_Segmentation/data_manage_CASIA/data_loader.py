...
cls_labels_dict = np.load('data_manage_CASIA/cls_labels.npy', allow_pickle=True).item()
...
class ImageDataset(Dataset):
    ...
    def __init__(self, root,data_list_path, width=320, height=240, transform=None):
        ...
        for i in range(len(self.img_name_list)):
            img_dir = os.path.join(self.root, self.img_name_list[i]+".jpg") #2021年9月29日、拡張子ベタ打ちになっている
